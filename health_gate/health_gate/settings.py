...
WSGI_APPLICATION = 'health_gate.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'USER': os.environ.get("SQL_USER", "heal_user"),
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': None   # нет ограничений на кол-во вывода экземпляров моделей на одной странице
}
