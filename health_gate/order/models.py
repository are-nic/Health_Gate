...
class OrderProduct(models.Model):
    ...
    recipe = models.ForeignKey(OrderRecipe, related_name='products', on_delete=models.CASCADE, verbose_name='Рецепт')
...
class MealPlanRecipe(models.Model):
    ...
    """
    owner = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='Владелец плана', related_name='owner')
